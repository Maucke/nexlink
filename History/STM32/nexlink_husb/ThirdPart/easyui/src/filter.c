...
{
    imu_data.pit+=(Gyro-q_bias) * dt; ///预测值
    ...
    angle_err = Accel -imu_data.pit;///测量值-预测值
    ...
    imu_data.pit+= K_0 * angle_err; ///最优角度 = 预测值 + 卡尔曼增益 * （测量值 - 预测值）
...
/****************************************
     Butterworth低通滤波器初始化：http://blog.csdn.net/u011992534/article/details/73743955
***************************************/
